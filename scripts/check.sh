...
python3 -m unittest application_status_test application_processes_test application_scope_test launch_plan_test input_context_test input_dispatch_test input_logging_test input_xim_test input_xpra_test display_test
